...
The Zylo Enterprise API provides a modern, RESTful API to work with SaaS subscription data. It enables the export of SaaS usage and subscription data to reporting tools outside of Zylo, as well as the import of additional unintegrated usage data. The API is built using resource-oriented URLs protected by HTTPS transport security and authenticated via bearer tokens. Key resources include subscriptions, applications, export jobs, and import jobs.
...
- [OpenAPI](openapi/zylo-enterprise-openapi.yml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [Postman Collection](collections/zylo-enterprise.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/zylo-enterprise.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)
...
- [Features](undefined)
- [L L Ms Txt](https://developer.zylo.com/llms.txt)
